...
export default function WhatsAppButton() {
  ...
  return (
    ...
    >
      <div
        className="w-11 h-11 rounded-full bg-green-500 text-white flex items-center justify-center shadow-lg relative"
      ...
      >
        ...
        <span className="absolute -right-2 -bottom-2 w-3 h-3 rounded-full bg-white/60 animate-ping"></span>
      </div>
    </a>
  );
}
